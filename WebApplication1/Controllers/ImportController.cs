    ...
    public class ImportController : Controller
    {
      ...
      //      TeamsStartlistChanged = TeamSMCompetion(excelImportService, TeamsStartlistChanged);
        ...
        private Dictionary<int, Changed> TeamOneDayCompetion(ExcelImportService excelImportService, Dictionary<int, Changed> TeamsStartlistChanged)
        {
            ...
            {
                CompetitionClassesTdbIds = new[] { 515963},             //senior lag
            ...
            {
                CompetitionClassesTdbIds = new[] { 515964 },            //Junior lag
                StepMoment = new StepMoment[]
                {
            ...
            startListTdbClass = new StartListTdbClasses
            {
                CompetitionClassesTdbIds = new[] { 515975 },  //Skrittklass, lag typ 1
            ...
            startListTdbClass = new StartListTdbClasses
            {
                CompetitionClassesTdbIds = new[] { 515972 },           //Mixklass D lag
                StepMoment = new StepMoment[]
    {
        ...
        private Dictionary<int, Changed> TeamOneDayTraHast(ExcelImportService excelImportService, Dictionary<int, Changed> TeamsStartlistChanged)
        {
            ...
            Changed changed;
            //Senior lag
            competionClassesTdbIds = new[] { 10006 };
            ...
            //Junior lag
            competionClassesTdbIds = new[] { 10005 };
            ...
            //Pas de deux
            competionClassesTdbIds = new[] { 10008 };
            ...
            //Showklass par
            competionClassesTdbIds = new[] { 10010 };
...
//            individualStartlistChanged = ImportIndividualSmCompetition(excelImportService, individualStartlistChanged);
            ...
            Dictionary<int, UpdateService.NewHordeorders> individualStartlistChanged)
        {
            ...
            var startListTdbClass = new StartListTdbClasses
            {
                CompetitionClassesTdbIds = new[] { 515965, 515966, 515968,  515969},
                StepMoment = new StepMoment[] {
            ...
            {
                CompetitionClassesTdbIds = new[] { 515965 },
                StepMoment = new StepMoment[] {
            ...
            startListTdbClass = new StartListTdbClasses
            {
                CompetitionClassesTdbIds = new[] { 515966, 515968, 515969 },
                StepMoment = new StepMoment[] {
            ...
            startListTdbClass = new StartListTdbClasses
            {
                CompetitionClassesTdbIds = new[] { 515978 }, // skritt klass individue och lätt
                StepMoment = new StepMoment[]
                {
                    new StepMoment { StartListClassStepId = 46, TestNumber = 1 },
                    new StepMoment { StartListClassStepId = 46, TestNumber = 2 }
            ...
            Dictionary<int, UpdateService.NewHordeorders> individualStartlistChanged)
        {
            ...
            //Svår klass alla klasser
            competionClassesTdbIds =
                new[] { 10001, 10002, 10003  }; //Svår klass individuella senior med och utan tekn, Juniorer-Miniorer
            ...
            competionClassesTdbIds =
                new[] { 10003 }; //Svår klass individuella senior med och utan tekn, Juniorer-Miniorer
    ...
    new[] { 10003 }; //Svår klass individuella senior med och utan tekn, Juniorer-Miniorer
            ...
            competionClassesTdbIds =
    new[] { 10001, 10002 }; //Svår klass individuella senior med och utan tekn, Juniorer-Miniorer
